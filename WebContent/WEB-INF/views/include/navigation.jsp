	...
	<ul>
		...
		<c:choose>
			<c:when test="${param.menu eq 'main'}">
				<li class="selected"><a href="/mysite/main">정기남</a></li>
				<li><a href="/mysite/gs">방명록</a></li>
				<li><a href="/mysite/bs">게시판</a></li>
			</c:when>
			<c:when test="${param.menu eq 'guestbook'}">
				<li ><a href="/mysite/main">정기남</a></li>
				<li class="selected"><a href="/mysite/gs">방명록</a></li>
				<li><a href="/mysite/bs">게시판</a></li>
			</c:when>
			<c:when test="${param.menu eq 'board'}">
				<li ><a href="/mysite/main">정기남</a></li>
				<li><a href="/mysite/gs">방명록</a></li>
				<li class="selected"><a href="/mysite/bs">게시판</a></li>
			</c:when>
		</c:choose>
